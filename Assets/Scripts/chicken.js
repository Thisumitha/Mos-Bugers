...
const addCartToHTML = () => {
    ...
    if(cart.length > 0){
        cart.forEach(item => {
            ...
            let positionProduct = chicken.findIndex((value) => value.itemCode == item.product_id);
            let info = chicken[positionProduct];
