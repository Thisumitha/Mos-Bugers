...
const addCartToHTML = () => {
    ...
    if(cart.length > 0){
        cart.forEach(item => {
            ...
            let positionProduct = fries.findIndex((value) => value.itemCode == item.product_id);
            let info = fries[positionProduct];
